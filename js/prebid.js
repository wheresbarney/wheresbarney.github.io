	...
	var AudienceNetworkAdapter = function AudienceNetworkAdapter() {
	  ...
	  var getTag = function getTag(tagVersion, placementId, bidId, format) {
	    switch (tagVersion) {
	      ...
	      case '5.5.web':
	        if (format === 'native') {
	          return '\n            <html>\n              <head>\n                <script type="text/javascript">\n                  window.onload = function() {\n                      if (parent) {\n                          var oHead = document.getElementsByTagName("head")[0];\n                          var arrStyleSheets = parent.document.getElementsByTagName("style");\n                          for (var i = 0; i < arrStyleSheets.length; i++)\n                              oHead.appendChild(arrStyleSheets[i].cloneNode(true));\n                      }\n                  }\n                </script>\n              </head>\n              <body>\n                <div style="display:none; position: relative;">\n                  <script type="text/javascript">\n                    var data = {\n                      placementid: \'' + placementId + '\',\n                      bidid: \'' + bidId + '\',\n                      format: \'' + format + '\',\n                      testmode: false,\n                      onAdLoaded: function(element) {\n                        console.log(\'Audience Network [' + placementId + '] ad loaded\');\n                        element.style.display = \'block\';\n                      },\n                      onAdError: function(errorCode, errorMessage) {\n                        console.log(\'Audience Network [' + placementId + '] error (\' + errorCode + \') \' + errorMessage);\n                      }\n                    };\n                    (function(a,b){var c=\'https://www.facebook.com\',d={iframeLoaded:true,xhrLoaded:true},e=function(da){if(da==null)throw new Error();return da;},f=function(da){if(da instanceof HTMLElement)return da;throw new Error();},g=function(){if(Date.now){return Date.now();}else return +new Date();},h=g(),i=function(){if(b.currentScript){return b.currentScript;}else{var da=b.getElementsByTagName(\'script\');return da[da.length-1];}},j=function(da){try{return da.document.referrer;}catch(ea){}return \'\';},k=function(){var da=a;try{while(da!=da.parent){da.parent.origin;da=da.parent;}}catch(ea){}return da;},l=k(),m=function(da){var ea=da.indexOf(\'/\',da.indexOf(\'://\')+3);if(ea===-1)return da;return da.substring(0,ea);},n=function(da){return da.location.href||j(da);},o=function(da,ea){if(!da.sdkLoaded){var fa=ea.createElement(\'script\');fa.src=\'https://connect.facebook.net/en_US/fbadnw55.js\';fa.async=true;e(ea.body).appendChild(fa);da.sdkLoaded=true;}},p=function(da,ea,fa){if(!da.iframe){var ga=fa.createElement(\'iframe\');ga.src=c+\'/audiencenetwork/iframe/\';ga.style.display=\'none\';e(fa.body).appendChild(ga);da.iframe=ga;da.iframeAppendedTime=g();}ea.iframe=e(da.iframe);ea.tagJsIframeAppendedTime=da.iframeAppendedTime||0;},q=function(da){var ea=c+\'/audiencenetwork/xhr/?sdk=5.5.web\';for(var fa in da)if(typeof da[fa]!==\'function\')ea+=\'&\'+fa+\'=\'+encodeURIComponent(da[fa]);var ga=new XMLHttpRequest();ga.open(\'GET\',ea,true);ga.withCredentials=true;ga.onreadystatechange=function(){if(ga.readyState===4)da.events.push({name:\'xhrLoaded\',source:da.iframe.contentWindow,data:JSON.parse(ga.response),postMessageTimestamp:g(),receivedTimestamp:g()});};ga.send();},r=function(da,ea){var fa=c+\'/audiencenetwork/xhriframe/?sdk=5.5.web\';for(var ga in ea)if(typeof ea[ga]!==\'function\')fa+=\'&\'+ga+\'=\'+encodeURIComponent(ea[ga]);var ha=b.createElement(\'iframe\');ha.src=fa;ha.style.display=\'none\';e(b.body).appendChild(ha);ea.iframe=ha;ea.tagJsIframeAppendedTime=g();},s=function(da){var ea=function(event){try{var ha=event.data;if(ha.name in d)da.events.push({name:ha.name,source:event.source,data:ha.data});}catch(ga){}},fa=e(da.iframe).contentWindow.parent;fa.addEventListener(\'message\',ea,false);},t=function(){if(l.context)return true;try{return !!JSON.parse(decodeURI(l.name)).ampcontextVersion;}catch(da){return false;}},u=a.data,v=f(i().parentElement),w=l!=a.top,x=l.$sf&&l.$sf.ext,y=n(l),z=m(y),aa=a.location.ancestorOrigins;if(aa&&aa.length)z=aa[aa.length-1];l.ADNW=l.ADNW||{};l.ADNW.v55=l.ADNW.v55||{ads:[]};var ba=l.ADNW.v55;o(ba,l.document);var ca={amp:t(),events:[],tagJsInitTime:h,rootElement:v,iframe:null,tagJsIframeAppendedTime:ba.iframeAppendedTime||0,url:y,domain:z,channel:m(n(a)),width:screen.width,height:screen.height,pixelratio:a.devicePixelRatio,placementindex:ba.ads.length,crossdomain:w,safeframe:!!x,placementid:u.placementid,format:u.format||\'300x250\',testmode:!!u.testmode,onAdLoaded:u.onAdLoaded,onAdError:u.onAdError};if(u.bidid)ca.bidid=u.bidid;ca.rootElement.dataset.placementid=ca.placementid;ba.ads.push(ca);if(w){r(ba,ca);}else{p(ba,ca,l.document);q(ca);}s(ca);})(window,document);\n                  </script>\n                  <div class="thirdPartyRoot">\n                    <a class="fbAdLink">\n                      <div class="fbAdMedia thirdPartyMediaClass"></div>\n                      <div class="fbAdSubtitle thirdPartySubtitleClass"></div>\n                      <div class="fbDefaultNativeAdWrapper">\n                        <div class="fbAdCallToAction thirdPartyCallToActionClass"></div>\n                        <div class="fbAdTitle thirdPartyTitleClass"></div>\n                      </div>\n                    </a>\n                  </div>\n                </div>\n              </body>\n            </html>';
	        }
	        return '\n          <div style="display:none; position: relative;">\n            <script type="text/javascript">\n              var data = {\n                placementid: \'' + placementId + '\',\n                bidid: \'' + bidId + '\',\n                format: \'' + format + '\',\n                testmode: false,\n                onAdLoaded: function(element) {\n                  console.log(\'Audience Network [' + placementId + '] ad loaded\');\n                  element.style.display = \'block\';\n                },\n                onAdError: function(errorCode, errorMessage) {\n                  console.log(\'Audience Network [' + placementId + '] error (\' + errorCode + \') \' + errorMessage);\n                  // PASSBACK goes here\n                }\n              };\n            </script>\n            <script>\n              (function(a,b){var c=\'https://www.facebook.com\',d={iframeLoaded:true,xhrLoaded:true},e=function(da){if(da==null)throw new Error();return da;},f=function(da){if(da instanceof HTMLElement)return da;throw new Error();},g=function(){if(Date.now){return Date.now();}else return +new Date();},h=g(),i=function(){if(b.currentScript){return b.currentScript;}else{var da=b.getElementsByTagName(\'script\');return da[da.length-1];}},j=function(da){try{return da.document.referrer;}catch(ea){}return \'\';},k=function(){var da=a;try{while(da!=da.parent){da.parent.origin;da=da.parent;}}catch(ea){}return da;},l=k(),m=function(da){var ea=da.indexOf(\'/\',da.indexOf(\'://\')+3);if(ea===-1)return da;return da.substring(0,ea);},n=function(da){return da.location.href||j(da);},o=function(da,ea){if(!da.sdkLoaded){var fa=ea.createElement(\'script\');fa.src=\'https://connect.facebook.net/en_US/fbadnw55.js\';fa.async=true;e(ea.body).appendChild(fa);da.sdkLoaded=true;}},p=function(da,ea,fa){if(!da.iframe){var ga=fa.createElement(\'iframe\');ga.src=c+\'/audiencenetwork/iframe/\';ga.style.display=\'none\';e(fa.body).appendChild(ga);da.iframe=ga;da.iframeAppendedTime=g();}ea.iframe=e(da.iframe);ea.tagJsIframeAppendedTime=da.iframeAppendedTime||0;},q=function(da){var ea=c+\'/audiencenetwork/xhr/?sdk=5.5.web\';for(var fa in da)if(typeof da[fa]!==\'function\')ea+=\'&\'+fa+\'=\'+encodeURIComponent(da[fa]);var ga=new XMLHttpRequest();ga.open(\'GET\',ea,true);ga.withCredentials=true;ga.onreadystatechange=function(){if(ga.readyState===4)da.events.push({name:\'xhrLoaded\',source:da.iframe.contentWindow,data:JSON.parse(ga.response),postMessageTimestamp:g(),receivedTimestamp:g()});};ga.send();},r=function(da,ea){var fa=c+\'/audiencenetwork/xhriframe/?sdk=5.5.web\';for(var ga in ea)if(typeof ea[ga]!==\'function\')fa+=\'&\'+ga+\'=\'+encodeURIComponent(ea[ga]);var ha=b.createElement(\'iframe\');ha.src=fa;ha.style.display=\'none\';e(b.body).appendChild(ha);ea.iframe=ha;ea.tagJsIframeAppendedTime=g();},s=function(da){var ea=function(event){try{var ha=event.data;if(ha.name in d)da.events.push({name:ha.name,source:event.source,data:ha.data});}catch(ga){}},fa=e(da.iframe).contentWindow.parent;fa.addEventListener(\'message\',ea,false);},t=function(){if(l.context)return true;try{return !!JSON.parse(decodeURI(l.name)).ampcontextVersion;}catch(da){return false;}},u=a.data,v=f(i().parentElement),w=l!=a.top,x=l.$sf&&l.$sf.ext,y=n(l),z=m(y),aa=a.location.ancestorOrigins;if(aa&&aa.length)z=aa[aa.length-1];l.ADNW=l.ADNW||{};l.ADNW.v55=l.ADNW.v55||{ads:[]};var ba=l.ADNW.v55;o(ba,l.document);var ca={amp:t(),events:[],tagJsInitTime:h,rootElement:v,iframe:null,tagJsIframeAppendedTime:ba.iframeAppendedTime||0,url:y,domain:z,channel:m(n(a)),width:screen.width,height:screen.height,pixelratio:a.devicePixelRatio,placementindex:ba.ads.length,crossdomain:w,safeframe:!!x,placementid:u.placementid,format:u.format||\'300x250\',testmode:!!u.testmode,onAdLoaded:u.onAdLoaded,onAdError:u.onAdError};if(u.bidid)ca.bidid=u.bidid;ca.rootElement.dataset.placementid=ca.placementid;ba.ads.push(ca);if(w){r(ba,ca);}else{p(ba,ca,l.document);q(ca);}s(ca);})(window,document);\n            </script>\n          </div>';
	
	      case '5.5.1.web':
	        if (format === 'native') {
	          return '\n                <html>\n                  <head>\n                    <script type="text/javascript">\n                      window.onload = function() {\n                          if (parent) {\n                              var oHead = document.getElementsByTagName("head")[0];\n                              var arrStyleSheets = parent.document.getElementsByTagName("style");\n                              for (var i = 0; i < arrStyleSheets.length; i++)\n                                  oHead.appendChild(arrStyleSheets[i].cloneNode(true));\n                          }\n                      }\n                    </script>\n                  </head>\n                  <body>\n                    <div style="display:none; position: relative;">\n                      <script type="text/javascript">\n                        var data = {\n                          placementid: \'' + placementId + '\',\n                          bidid: \'' + bidId + '\',\n                          format: \'' + format + '\',\n                          testmode: false,\n                          onAdLoaded: function(element) {\n                            console.log(\'Audience Network [' + placementId + '] ad loaded\');\n                            element.style.display = \'block\';\n                          },\n                          onAdError: function(errorCode, errorMessage) {\n                            console.log(\'Audience Network [' + placementId + '] error (\' + errorCode + \') \' + errorMessage);\n                          }\n                        };\n                        (function(a,b,c){var d=\'https://www.facebook.com\',e=\'https://connect.facebook.net/en_US/fbadnw55.js\',f={iframeLoaded:true,xhrLoaded:true},g=a.data,h=function(ca){if(ca==null)throw new Error();return ca;},i=function(ca){if(ca instanceof HTMLElement)return ca;throw new Error();},j=function(){if(Date.now){return Date.now();}else return +new Date();},k=function(ca){var da=d+\'/audience_network/client_event\',ea={cb:j(),event_name:\'ADNW_ADERROR\',ad_pivot_type:\'audience_network_mobile_web\',sdk_version:\'5.5.1.web\',app_id:g.placementid.split(\'_\')[0],publisher_id:g.placementid.split(\'_\')[1],error_message:ca},fa=[];for(var ga in ea)fa.push(encodeURIComponent(ga)+\'=\'+encodeURIComponent(ea[ga]));var ha=da+\'?\'+fa.join(\'&\'),ia=new XMLHttpRequest();ia.open(\'GET\',ha,true);ia.send();},l=function(){if(b.currentScript){return b.currentScript;}else{var ca=b.getElementsByTagName(\'script\');return ca[ca.length-1];}},m=function(ca){try{return ca.document.referrer;}catch(da){}return \'\';},n=function(){var ca=a;try{while(ca!=ca.parent){ca.parent.origin;ca=ca.parent;}}catch(da){}return ca;},o=function(ca){var da=ca.indexOf(\'/\',ca.indexOf(\'://\')+3);if(da===-1)return ca;return ca.substring(0,da);},p=function(ca){return ca.location.href||m(ca);},q=function(ca,da){if(ca.sdkLoaded)return;var ea=da.createElement(\'iframe\');ea.name=\'fbadnw\';ea.style.display=\'none\';h(da.body).appendChild(ea);ea.contentWindow.addEventListener(\'error\',function(event){k(event.message);},false);var fa=ea.contentDocument.createElement(\'script\');fa.src=e;fa.async=true;h(ea.contentDocument.body).appendChild(fa);ca.sdkLoaded=true;},r=function(ca){var da=/^https?:\\/\\/www\\.google(\\.com?)?.\\w{2,3}$/;return !!ca.match(da);},s=function(ca){return ca.endsWith(\'cdn.ampproject.org\');},t=function(){var ca=c.ancestorOrigins||[],da=ca[ca.length-1]||c.origin,ea=ca[ca.length-2]||c.origin;if(r(da)&&s(ea)){return o(ea);}else return o(da);},u=function(ca){try{return JSON.parse(ca);}catch(da){k(da.message);return null;}},v=function(ca,da,ea){if(!ca.iframe){var fa=ea.createElement(\'iframe\');fa.src=d+\'/audiencenetwork/iframe/\';fa.style.display=\'none\';h(ea.body).appendChild(fa);ca.iframe=fa;ca.iframeAppendedTime=j();ca.iframeData={};}da.iframe=h(ca.iframe);da.iframeData=ca.iframeData;da.tagJsIframeAppendedTime=ca.iframeAppendedTime||0;},w=function(ca){var da=d+\'/audiencenetwork/xhr/?sdk=5.5.1.web\';for(var ea in ca)if(typeof ca[ea]!==\'function\')da+=\'&\'+ea+\'=\'+encodeURIComponent(ca[ea]);var fa=new XMLHttpRequest();fa.open(\'GET\',da,true);fa.withCredentials=true;fa.onreadystatechange=function(){if(fa.readyState===4){var ga=u(fa.response);if(ga)ca.events.push({name:\'xhrLoaded\',source:ca.iframe.contentWindow,data:ga,postMessageTimestamp:j(),receivedTimestamp:j()});}};fa.send();},x=function(ca,da){var ea=d+\'/audiencenetwork/xhriframe/?sdk=5.5.1.web\';for(var fa in da)if(typeof da[fa]!==\'function\')ea+=\'&\'+fa+\'=\'+encodeURIComponent(da[fa]);var ga=b.createElement(\'iframe\');ga.src=ea;ga.style.display=\'none\';h(b.body).appendChild(ga);da.iframe=ga;da.iframeData={};da.tagJsIframeAppendedTime=j();},y=function(ca){var da=function(event){try{var ga=event.data;if(ga.name in f)ca.events.push({name:ga.name,source:event.source,data:ga.data});}catch(fa){}},ea=h(ca.iframe).contentWindow.parent;ea.addEventListener(\'message\',da,false);},z=function(ca){if(ca.context)return true;try{return !!JSON.parse(decodeURI(ca.name)).ampcontextVersion;}catch(da){return false;}},aa=function(ca){var da=j(),ea=n(),fa=i(l().parentElement),ga=ea!=a.top,ha=ea.$sf&&ea.$sf.ext,ia=p(ea);ea.ADNW=ea.ADNW||{};ea.ADNW.v55=ea.ADNW.v55||{ads:[]};var ja=ea.ADNW.v55;q(ja,ea.document);var ka={amp:z(ea),events:[],tagJsInitTime:da,rootElement:fa,iframe:null,tagJsIframeAppendedTime:ja.iframeAppendedTime||0,url:ia,domain:t(),channel:o(p(a)),width:screen.width,height:screen.height,pixelratio:a.devicePixelRatio,placementindex:ja.ads.length,crossdomain:ga,safeframe:!!ha,placementid:g.placementid,format:g.format||\'300x250\',testmode:!!g.testmode,onAdLoaded:g.onAdLoaded,onAdError:g.onAdError};if(g.bidid)ka.bidid=g.bidid;if(ga){x(ja,ka);}else{v(ja,ka,ea.document);w(ka);}y(ka);ka.rootElement.dataset.placementid=ka.placementid;ja.ads.push(ka);};try{aa();}catch(ba){k(ba.message||ba);throw ba;}})(window,document,location);\n                      </script>\n                      <div class="thirdPartyRoot">\n                        <a class="fbAdLink">\n                          <div class="fbAdMedia thirdPartyMediaClass"></div>\n                          <div class="fbAdSubtitle thirdPartySubtitleClass"></div>\n                          <div class="fbDefaultNativeAdWrapper">\n                            <div class="fbAdCallToAction thirdPartyCallToActionClass"></div>\n                            <div class="fbAdTitle thirdPartyTitleClass"></div>\n                          </div>\n                        </a>\n                      </div>\n                    </div>\n                  </body>\n                </html>';
	        }
	        return '\n              <div style="display:none; position: relative;">\n                <script type="text/javascript">\n                  var data = {\n                    placementid: \'' + placementId + '\',\n                    bidid: \'' + bidId + '\',\n                    format: \'' + format + '\',\n                    testmode: false,\n                    onAdLoaded: function(element) {\n                      console.log(\'Audience Network [' + placementId + '] ad loaded\');\n                      element.style.display = \'block\';\n                    },\n                    onAdError: function(errorCode, errorMessage) {\n                      console.log(\'Audience Network [' + placementId + '] error (\' + errorCode + \') \' + errorMessage);\n                      // PASSBACK goes here\n                    }\n                  };\n                </script>\n                <script>\n                  (function(a,b,c){var d=\'https://www.facebook.com\',e=\'https://connect.facebook.net/en_US/fbadnw55.js\',f={iframeLoaded:true,xhrLoaded:true},g=a.data,h=function(ca){if(ca==null)throw new Error();return ca;},i=function(ca){if(ca instanceof HTMLElement)return ca;throw new Error();},j=function(){if(Date.now){return Date.now();}else return +new Date();},k=function(ca){var da=d+\'/audience_network/client_event\',ea={cb:j(),event_name:\'ADNW_ADERROR\',ad_pivot_type:\'audience_network_mobile_web\',sdk_version:\'5.5.1.web\',app_id:g.placementid.split(\'_\')[0],publisher_id:g.placementid.split(\'_\')[1],error_message:ca},fa=[];for(var ga in ea)fa.push(encodeURIComponent(ga)+\'=\'+encodeURIComponent(ea[ga]));var ha=da+\'?\'+fa.join(\'&\'),ia=new XMLHttpRequest();ia.open(\'GET\',ha,true);ia.send();},l=function(){if(b.currentScript){return b.currentScript;}else{var ca=b.getElementsByTagName(\'script\');return ca[ca.length-1];}},m=function(ca){try{return ca.document.referrer;}catch(da){}return \'\';},n=function(){var ca=a;try{while(ca!=ca.parent){ca.parent.origin;ca=ca.parent;}}catch(da){}return ca;},o=function(ca){var da=ca.indexOf(\'/\',ca.indexOf(\'://\')+3);if(da===-1)return ca;return ca.substring(0,da);},p=function(ca){return ca.location.href||m(ca);},q=function(ca,da){if(ca.sdkLoaded)return;var ea=da.createElement(\'iframe\');ea.name=\'fbadnw\';ea.style.display=\'none\';h(da.body).appendChild(ea);ea.contentWindow.addEventListener(\'error\',function(event){k(event.message);},false);var fa=ea.contentDocument.createElement(\'script\');fa.src=e;fa.async=true;h(ea.contentDocument.body).appendChild(fa);ca.sdkLoaded=true;},r=function(ca){var da=/^https?:\\/\\/www\\.google(\\.com?)?.\\w{2,3}$/;return !!ca.match(da);},s=function(ca){return ca.endsWith(\'cdn.ampproject.org\');},t=function(){var ca=c.ancestorOrigins||[],da=ca[ca.length-1]||c.origin,ea=ca[ca.length-2]||c.origin;if(r(da)&&s(ea)){return o(ea);}else return o(da);},u=function(ca){try{return JSON.parse(ca);}catch(da){k(da.message);return null;}},v=function(ca,da,ea){if(!ca.iframe){var fa=ea.createElement(\'iframe\');fa.src=d+\'/audiencenetwork/iframe/\';fa.style.display=\'none\';h(ea.body).appendChild(fa);ca.iframe=fa;ca.iframeAppendedTime=j();ca.iframeData={};}da.iframe=h(ca.iframe);da.iframeData=ca.iframeData;da.tagJsIframeAppendedTime=ca.iframeAppendedTime||0;},w=function(ca){var da=d+\'/audiencenetwork/xhr/?sdk=5.5.1.web\';for(var ea in ca)if(typeof ca[ea]!==\'function\')da+=\'&\'+ea+\'=\'+encodeURIComponent(ca[ea]);var fa=new XMLHttpRequest();fa.open(\'GET\',da,true);fa.withCredentials=true;fa.onreadystatechange=function(){if(fa.readyState===4){var ga=u(fa.response);if(ga)ca.events.push({name:\'xhrLoaded\',source:ca.iframe.contentWindow,data:ga,postMessageTimestamp:j(),receivedTimestamp:j()});}};fa.send();},x=function(ca,da){var ea=d+\'/audiencenetwork/xhriframe/?sdk=5.5.1.web\';for(var fa in da)if(typeof da[fa]!==\'function\')ea+=\'&\'+fa+\'=\'+encodeURIComponent(da[fa]);var ga=b.createElement(\'iframe\');ga.src=ea;ga.style.display=\'none\';h(b.body).appendChild(ga);da.iframe=ga;da.iframeData={};da.tagJsIframeAppendedTime=j();},y=function(ca){var da=function(event){try{var ga=event.data;if(ga.name in f)ca.events.push({name:ga.name,source:event.source,data:ga.data});}catch(fa){}},ea=h(ca.iframe).contentWindow.parent;ea.addEventListener(\'message\',da,false);},z=function(ca){if(ca.context)return true;try{return !!JSON.parse(decodeURI(ca.name)).ampcontextVersion;}catch(da){return false;}},aa=function(ca){var da=j(),ea=n(),fa=i(l().parentElement),ga=ea!=a.top,ha=ea.$sf&&ea.$sf.ext,ia=p(ea);ea.ADNW=ea.ADNW||{};ea.ADNW.v55=ea.ADNW.v55||{ads:[]};var ja=ea.ADNW.v55;q(ja,ea.document);var ka={amp:z(ea),events:[],tagJsInitTime:da,rootElement:fa,iframe:null,tagJsIframeAppendedTime:ja.iframeAppendedTime||0,url:ia,domain:t(),channel:o(p(a)),width:screen.width,height:screen.height,pixelratio:a.devicePixelRatio,placementindex:ja.ads.length,crossdomain:ga,safeframe:!!ha,placementid:g.placementid,format:g.format||\'300x250\',testmode:!!g.testmode,onAdLoaded:g.onAdLoaded,onAdError:g.onAdError};if(g.bidid)ka.bidid=g.bidid;if(ga){x(ja,ka);}else{v(ja,ka,ea.document);w(ka);}y(ka);ka.rootElement.dataset.placementid=ka.placementid;ja.ads.push(ka);};try{aa();}catch(ba){k(ba.message||ba);throw ba;}})(window,document,location);\n                </script>\n              </div>';
	
	      case '5.5.2.web':
	        if (format === 'native') {
	          return '\n                    <html>\n                      <head>\n                        <script type="text/javascript">\n                          window.onload = function() {\n                              if (parent) {\n                                  var oHead = document.getElementsByTagName("head")[0];\n                                  var arrStyleSheets = parent.document.getElementsByTagName("style");\n                                  for (var i = 0; i < arrStyleSheets.length; i++)\n                                      oHead.appendChild(arrStyleSheets[i].cloneNode(true));\n                              }\n                          }\n                        </script>\n                      </head>\n                      <body>\n                        <div style="display:none; position: relative;">\n                          <script type="text/javascript">\n                            var data = {\n                              placementid: \'' + placementId + '\',\n                              bidid: \'' + bidId + '\',\n                              format: \'' + format + '\',\n                              testmode: false,\n                              onAdLoaded: function(element) {\n                                console.log(\'Audience Network [' + placementId + '] ad loaded\');\n                                element.style.display = \'block\';\n                              },\n                              onAdError: function(errorCode, errorMessage) {\n                                console.log(\'Audience Network [' + placementId + '] error (\' + errorCode + \') \' + errorMessage);\n                              }\n                            };\n                            (function(a,b,c){var d=\'https://www.facebook.com\',e=\'https://connect.facebook.net/en_US/fbadnw55.js\',f={iframeLoaded:true,xhrLoaded:true},g=a.data,h=function(z){if(z==null)throw new Error();return z;},i=function(z){if(z instanceof HTMLElement)return z;throw new Error();},j=function(){if(Date.now){return Date.now();}else return +new Date();},k=function(z){var aa=d+\'/audience_network/client_event\',ba={cb:j(),event_name:\'ADNW_ADERROR\',ad_pivot_type:\'audience_network_mobile_web\',sdk_version:\'5.5.2.web\',app_id:g.placementid.split(\'_\')[0],publisher_id:g.placementid.split(\'_\')[1],error_message:z},ca=[];for(var da in ba)ca.push(encodeURIComponent(da)+\'=\'+encodeURIComponent(ba[da]));var ea=aa+\'?\'+ca.join(\'&\'),fa=new XMLHttpRequest();fa.open(\'GET\',ea,true);fa.send();},l=function(){if(b.currentScript){return b.currentScript;}else{var z=b.getElementsByTagName(\'script\');return z[z.length-1];}},m=function(z){try{return z.document.referrer;}catch(aa){}return \'\';},n=function(){var z=a;try{while(z!=z.parent){z.parent.origin;z=z.parent;}}catch(aa){}return z;},o=function(z){var aa=z.indexOf(\'/\',z.indexOf(\'://\')+3);if(aa===-1)return z;return z.substring(0,aa);},p=function(z){return z.location.href||m(z);},q=function(z,aa){if(z.sdkLoaded)return;var ba=aa.createElement(\'iframe\');ba.name=\'fbadnw\';ba.style.display=\'none\';h(aa.body).appendChild(ba);ba.contentWindow.addEventListener(\'error\',function(event){k(event.message);},false);var ca=ba.contentDocument.createElement(\'script\');ca.src=e;ca.async=true;h(ba.contentDocument.body).appendChild(ca);z.sdkLoaded=true;},r=function(z){var aa=/^https?:\\/\\/www\\.google(\\.com?)?.\\w{2,3}$/;return !!z.match(aa);},s=function(z){return z.endsWith(\'cdn.ampproject.org\');},t=function(){var z=c.ancestorOrigins||[],aa=z[z.length-1]||c.origin,ba=z[z.length-2]||c.origin;if(r(aa)&&s(ba)){return o(ba);}else return o(aa);},u=function(z,aa){var ba=d+\'/audiencenetwork/xhriframe/?sdk=5.5.2.web\';for(var ca in aa)if(typeof aa[ca]!==\'function\')ba+=\'&\'+ca+\'=\'+encodeURIComponent(aa[ca]);var da=b.createElement(\'iframe\');da.src=ba;da.style.display=\'none\';h(b.body).appendChild(da);aa.iframe=da;aa.iframeData={};aa.tagJsIframeAppendedTime=j();},v=function(z){var aa=function(event){try{var da=event.data;if(da.name in f)z.events.push({name:da.name,source:event.source,data:da.data});}catch(ca){}},ba=h(z.iframe).contentWindow.parent;ba.addEventListener(\'message\',aa,false);},w=function(z){if(z.context)return true;try{return !!JSON.parse(decodeURI(z.name)).ampcontextVersion;}catch(aa){return false;}},x=function(z){var aa=j(),ba=n(),ca=i(l().parentElement),da=ba!=a.top,ea=ba.$sf&&ba.$sf.ext,fa=p(ba);ba.ADNW=ba.ADNW||{};ba.ADNW.v55=ba.ADNW.v55||{ads:[]};var ga=ba.ADNW.v55;q(ga,ba.document);var ha={amp:w(ba),events:[],tagJsInitTime:aa,rootElement:ca,iframe:null,tagJsIframeAppendedTime:ga.iframeAppendedTime||0,url:fa,domain:t(),channel:o(p(a)),width:screen.width,height:screen.height,pixelratio:a.devicePixelRatio,placementindex:ga.ads.length,crossdomain:da,safeframe:!!ea,placementid:g.placementid,format:g.format||\'300x250\',testmode:!!g.testmode,onAdLoaded:g.onAdLoaded,onAdError:g.onAdError};if(g.bidid)ha.bidid=g.bidid;u(ga,ha);v(ha);ha.rootElement.dataset.placementid=ha.placementid;ga.ads.push(ha);};try{x();}catch(y){k(y.message||y);throw y;}})(window,document,location);\n                          </script>\n                          <div class="thirdPartyRoot">\n                            <a class="fbAdLink">\n                              <div class="fbAdMedia thirdPartyMediaClass"></div>\n                              <div class="fbAdSubtitle thirdPartySubtitleClass"></div>\n                              <div class="fbDefaultNativeAdWrapper">\n                                <div class="fbAdCallToAction thirdPartyCallToActionClass"></div>\n                                <div class="fbAdTitle thirdPartyTitleClass"></div>\n                              </div>\n                            </a>\n                          </div>\n                        </div>\n                      </body>\n                    </html>';
	        }
	        return '\n                  <div style="display:none; position: relative;">\n                    <script type="text/javascript">\n                      var data = {\n                        placementid: \'' + placementId + '\',\n                        bidid: \'' + bidId + '\',\n                        format: \'' + format + '\',\n                        testmode: false,\n                        onAdLoaded: function(element) {\n                          console.log(\'Audience Network [' + placementId + '] ad loaded\');\n                          element.style.display = \'block\';\n                        },\n                        onAdError: function(errorCode, errorMessage) {\n                          console.log(\'Audience Network [' + placementId + '] error (\' + errorCode + \') \' + errorMessage);\n                          // PASSBACK goes here\n                        }\n                      };\n                    </script>\n                    <script>\n                      (function(a,b,c){var d=\'https://www.facebook.com\',e=\'https://connect.facebook.net/en_US/fbadnw55.js\',f={iframeLoaded:true,xhrLoaded:true},g=a.data,h=function(z){if(z==null)throw new Error();return z;},i=function(z){if(z instanceof HTMLElement)return z;throw new Error();},j=function(){if(Date.now){return Date.now();}else return +new Date();},k=function(z){var aa=d+\'/audience_network/client_event\',ba={cb:j(),event_name:\'ADNW_ADERROR\',ad_pivot_type:\'audience_network_mobile_web\',sdk_version:\'5.5.2.web\',app_id:g.placementid.split(\'_\')[0],publisher_id:g.placementid.split(\'_\')[1],error_message:z},ca=[];for(var da in ba)ca.push(encodeURIComponent(da)+\'=\'+encodeURIComponent(ba[da]));var ea=aa+\'?\'+ca.join(\'&\'),fa=new XMLHttpRequest();fa.open(\'GET\',ea,true);fa.send();},l=function(){if(b.currentScript){return b.currentScript;}else{var z=b.getElementsByTagName(\'script\');return z[z.length-1];}},m=function(z){try{return z.document.referrer;}catch(aa){}return \'\';},n=function(){var z=a;try{while(z!=z.parent){z.parent.origin;z=z.parent;}}catch(aa){}return z;},o=function(z){var aa=z.indexOf(\'/\',z.indexOf(\'://\')+3);if(aa===-1)return z;return z.substring(0,aa);},p=function(z){return z.location.href||m(z);},q=function(z,aa){if(z.sdkLoaded)return;var ba=aa.createElement(\'iframe\');ba.name=\'fbadnw\';ba.style.display=\'none\';h(aa.body).appendChild(ba);ba.contentWindow.addEventListener(\'error\',function(event){k(event.message);},false);var ca=ba.contentDocument.createElement(\'script\');ca.src=e;ca.async=true;h(ba.contentDocument.body).appendChild(ca);z.sdkLoaded=true;},r=function(z){var aa=/^https?:\\/\\/www\\.google(\\.com?)?.\\w{2,3}$/;return !!z.match(aa);},s=function(z){return z.endsWith(\'cdn.ampproject.org\');},t=function(){var z=c.ancestorOrigins||[],aa=z[z.length-1]||c.origin,ba=z[z.length-2]||c.origin;if(r(aa)&&s(ba)){return o(ba);}else return o(aa);},u=function(z,aa){var ba=d+\'/audiencenetwork/xhriframe/?sdk=5.5.2.web\';for(var ca in aa)if(typeof aa[ca]!==\'function\')ba+=\'&\'+ca+\'=\'+encodeURIComponent(aa[ca]);var da=b.createElement(\'iframe\');da.src=ba;da.style.display=\'none\';h(b.body).appendChild(da);aa.iframe=da;aa.iframeData={};aa.tagJsIframeAppendedTime=j();},v=function(z){var aa=function(event){try{var da=event.data;if(da.name in f)z.events.push({name:da.name,source:event.source,data:da.data});}catch(ca){}},ba=h(z.iframe).contentWindow.parent;ba.addEventListener(\'message\',aa,false);},w=function(z){if(z.context)return true;try{return !!JSON.parse(decodeURI(z.name)).ampcontextVersion;}catch(aa){return false;}},x=function(z){var aa=j(),ba=n(),ca=i(l().parentElement),da=ba!=a.top,ea=ba.$sf&&ba.$sf.ext,fa=p(ba);ba.ADNW=ba.ADNW||{};ba.ADNW.v55=ba.ADNW.v55||{ads:[]};var ga=ba.ADNW.v55;q(ga,ba.document);var ha={amp:w(ba),events:[],tagJsInitTime:aa,rootElement:ca,iframe:null,tagJsIframeAppendedTime:ga.iframeAppendedTime||0,url:fa,domain:t(),channel:o(p(a)),width:screen.width,height:screen.height,pixelratio:a.devicePixelRatio,placementindex:ga.ads.length,crossdomain:da,safeframe:!!ea,placementid:g.placementid,format:g.format||\'300x250\',testmode:!!g.testmode,onAdLoaded:g.onAdLoaded,onAdError:g.onAdError};if(g.bidid)ha.bidid=g.bidid;u(ga,ha);v(ha);ha.rootElement.dataset.placementid=ha.placementid;ga.ads.push(ha);};try{x();}catch(y){k(y.message||y);throw y;}})(window,document,location);\n                    </script>\n                  </div>';
