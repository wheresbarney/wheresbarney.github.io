...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}require("whatwg-fetch");var _isArray=require("lodash/isArray"),_isArray2=_interopRequireDefault(_isArray),_isFunction=require("lodash/isFunction"),_isFunction2=_interopRequireDefault(_isFunction),_isObject=require("lodash/isObject"),_isObject2=_interopRequireDefault(_isObject),_isString=require("lodash/isString"),_isString2=_interopRequireDefault(_isString),name="audience-network",validateSlot=function(e){return(0,_isObject2.default)(e)&&(0,_isString2.default)(e.name)&&(0,_isString2.default)(e.elementId)&&(0,_isArray2.default)(e.sizes)&&e.sizes.length>0&&(0,_isFunction2.default)(e.getParam)&&(0,_isObject2.default)(e.getParam(name))&&(0,_isString2.default)(e.getParam(name).placementId)},validateSlotSizes=function(e){return e.sizes.map(flattenSize).every(function(e){return["native","300x250","300x50"].includes(e)})},flattenSize=function(e){return(0,_isArray2.default)(e)&&2===e.length?e[0]+"x"+e[1]:e},url=function(e,t){return["https://an.facebook.com/v2/placementbid.json?sdk=5.5.web"].concat(e.map(function(e){return"placementids[]="+e})).concat(t.map(function(e){return"adformats[]="+e})).join("&")},isNative=function(e){return"native"===e},init=function(e,t,i){var n=[],r=[],a=[];e.filter(validateSlot).filter(validateSlotSizes).forEach(function(e){return e.sizes.forEach(function(t){n.push(e.getParam(name).placementId),r.push(flattenSize(t)),a.push(e.name)})}),n.length?fetch(url(n,r),{credentials:"include"}).then(function(e){return e.json()}).then(function(e){(0,_isArray2.default)(e.errors)&&e.errors.length?i(new Error(e.errors.join())):(Object.keys(e.bids).map(function(t){return e.bids[t]}).reduce(function(e,t){return e.concat(t)},[]).forEach(function(e,i){var n=String((Math.floor(e.bid_price_cents/10)/10).toFixed(2));t({id:e.bid_id,slot:a[i],value:n,sizes:isNative(r[i])?[0,0]:r[i].split("x").map(Number),targeting:{hb_bidder:"fan",hb_pb:n,fb_placementid:e.placement_id,fb_bidid:e.bid_id,fb_format:r[i]}})}),i())}).catch(i):i(new Error("No valid slots requested"))},AudienceNetworkBidDelegate=function(){return{name:name,init:init,refresh:init}};module.exports=AudienceNetworkBidDelegate;
