...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}require("whatwg-fetch");var _isArray=require("lodash/isArray"),_isArray2=_interopRequireDefault(_isArray),_isFunction=require("lodash/isFunction"),_isFunction2=_interopRequireDefault(_isFunction),_isObject=require("lodash/isObject"),_isObject2=_interopRequireDefault(_isObject),_isString=require("lodash/isString"),_isString2=_interopRequireDefault(_isString),name="audience-network",validateSlot=function(e){return(0,_isObject2.default)(e)&&(0,_isString2.default)(e.name)&&(0,_isString2.default)(e.elementId)&&(0,_isArray2.default)(e.sizes)&&e.sizes.length>0&&(0,_isFunction2.default)(e.getParam)&&(0,_isObject2.default)(e.getParam(name))&&(0,_isString2.default)(e.getParam(name).placementId)&&(0,_isString2.default)(e.getParam(name).format)},validateSlotSizes=function(e){return e.sizes.every(function(e){return["300x250","320x50"].includes(e.join("x"))})},url=function(e,t,i){return["https://an.facebook.com/v2/placementbid.json?sdk="+e].concat(t.map(function(e){return"placementids[]="+e})).concat(i.map(function(e){return"adformats[]="+e})).join("&")},isNative=function(e){return["native","fullwidth"].includes(e)},init=function(e,t,i,n){var r=[],a=[],u=[];t.filter(validateSlot).filter(validateSlotSizes).forEach(function(e){r.push(e.getParam(name).placementId),a.push(e.getParam(name).format),u.push(e.name)}),r.length?fetch(url(e,r,a),{credentials:"include"}).then(function(e){return e.json()}).then(function(e){(0,_isArray2.default)(e.errors)&&e.errors.length?n(new Error(e.errors.join())):(Object.keys(e.bids).map(function(t){return e.bids[t]}).reduce(function(e,t){return e.concat(t)},[]).forEach(function(e,t){var n=String((Math.floor(e.bid_price_cents/10)/10).toFixed(2));i({id:e.bid_id,slot:u[t],value:n,sizes:isNative(a[t])?[300,250]:a[t].split("x").map(Number),targeting:{hb_bidder:"fan",hb_pb:n,fb_placementid:e.placement_id,fb_bidid:e.bid_id,fb_format:a[t]}})}),n())}).catch(n):n(new Error("No valid slots requested"))},AudienceNetworkBidDelegate=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"5.5.web";return{name:name,init:init.bind(null,e),refresh:init.bind(null,e)}};module.exports=AudienceNetworkBidDelegate;
